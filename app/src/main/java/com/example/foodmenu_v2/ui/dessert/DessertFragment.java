...
public class DessertFragment extends Fragment {
    ...
    private void GetDataFromDb(){
        DessertsListData = new ArrayList<Product>();
        ...
        Query query = databaseRef.orderByChild("category").equalTo("desserts");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    DessertsListData.add(newProduct);
                }
                if(DessertsListData.size() == 0)
                ...
                ProductAdapter adapter = new ProductAdapter(DessertsListData, getContext());
